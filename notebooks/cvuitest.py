...
def main(x,y):
	...
	while (True):
		...
		snapshot = cv2.resize(snapshot, (224*2, 224*2))
		cvui.image(frame, 10, 400, snapshot)
		cvui.window(frame, 50, 120, 120, 100, 'Window')
		#cvui.imshow('Window', pic)
		...
		cvui.printf(frame, window_w - 80, window_h - 20, 0.4, 0xCECECE, 'cvui v.%s', cvui.VERSION)
